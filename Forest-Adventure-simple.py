...
def house():
    # straight path outcome
    print("You find you have reached the edge of the forest.")
    print("You find a house and knock on the door.")
    out_of_forest()

def field():
    # right path outcome
    print("You stumble out to the edge of a field.")
    out_of_forest()
